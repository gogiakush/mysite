...
function updateGameArea() {
    ...
    if(enemytimer % 100 == 0) {
        enemies.push(new enemy(50, 50, "./img/enemyship.png", Math.floor(Math.random() * myGameArea.canvas.width), -100, "image"));
    }
...
function setUpGame() {
    myGameArea.start();
    myGamePiece = new spaceship(150, 150, "./img/spaceship.png", myGameArea.canvas.width / 2, myGameArea.canvas.height-75, "image");
    createStars();
}
